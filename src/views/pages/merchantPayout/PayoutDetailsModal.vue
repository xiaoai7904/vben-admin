...
<script lang="ts">
  ...
  import { PayOutDetailsApi } from '/@/api/page';
  import { detailsSchema, orderState, notifyState, opState } from './payout.data';
  export default defineComponent({
    ...
    setup(_) {
      ...
      const [registerModal, { setModalProps, closeModal }] = useModalInner(async (data) => {
        ...
        try {
          loading.value = true;
          const result = await PayOutDetailsApi({ pOrderId: data.record.pOrderId });
