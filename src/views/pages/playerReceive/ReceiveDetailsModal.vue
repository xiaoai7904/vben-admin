...
<script lang="ts">
  ...
  import { PlayerOrderDetailsApi } from '/@/api/page';
  import { detailsSchema, orderState, opState } from './receive.data';
  export default defineComponent({
    ...
    setup(_) {
      ...
      const [registerModal, { setModalProps, closeModal }] = useModalInner(async (data) => {
        ...
        try {
          loading.value = true;
          const result = await PlayerOrderDetailsApi({ pOrderId: data.record.pOrderId });
